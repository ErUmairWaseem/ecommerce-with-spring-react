...
public class Product {
	...
	public Product(Long id, String title, String description, float price, float discountedPrice,
			float discountedPercent, int quantity, String brand, String color, Set<Size> sizes, String imageUrl,
